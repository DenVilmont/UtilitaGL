...
public class VentanaLog {
    ...
    private void rellenarTodosDatos(){
        datosEncontrados = new ArrayList<>();
        ...
        for (String[] logDataArray : logData) {
            String s = (logDataArray[1].length() < 100) ? logDataArray[1] : logDataArray[1].substring(0,100);
            modeloInfo.addRow(new String[]{logDataArray[0], s});
        }
